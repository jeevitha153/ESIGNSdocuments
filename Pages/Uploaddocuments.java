	...
	public void Dropbox() throws Exception {
		...
		for (String childwindow : allwindowhandles) {
			if (!childwindow.endsWith(Parentwindowid)) {
				...
				try {
					Thread.sleep(10000);
					driver.switchTo().frame("consent-iframe");
					Thread.sleep(10000);
					driver.findElement(By.xpath("//button[@id=\"accept_all_cookies_button\"]")).click();
//					By Element1 = By.xpath("//*[@id=\"accept_all_cookies_button\"]");
