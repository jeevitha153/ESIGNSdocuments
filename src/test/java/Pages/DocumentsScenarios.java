...
//		System.out.println("Click on create Document Done Successfully");
	...
	public void RecipientSignerToTemplate1(String contactType, String signerType) throws Exception {
...
//		waitEle(By.xpath(xpath));
	...
	public void Docsend(int id, String Mail) throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
		WebElement element = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//span[normalize-space()=\"Send Document\"]")));
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", element);
...
//		waitEle(By.xpath("(//span[normalize-space()='Save'])[3]"));
	...
	public void clickSubmit2() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
		Thread.sleep(5000);
		WebElement element = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[normalize-space()='Send Document']")));
	...
	public void clickSubmit1() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
		Thread.sleep(5000); // Consider removing this if not needed

		try {
			WebElement element = wait.until(
					ExpectedConditions.elementToBeClickable(By.xpath("//span[normalize-space()='Send Document']")));
			System.out.println("About to click 'Send Document' button");
			element.click(); // Direct click method
			System.out.println("Clicked 'Send Document' button");
		} catch (Exception e) {
			System.out.println("Exception occurred while clicking 'Send Document' button: " + e.getMessage());
		}

		Thread.sleep(10000); // Consider reducing the sleep time
	}
...
//		WebElement singleelement2 = driver.findElement(By.xpath("//div[@class='form-fields-holder']//div[@data-text='Single Line Text %d']"));
	...
	public void RecipientSignerToTemplate(String contactType, String signerType) throws Exception {
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", element); // String xpath =
																						// String.format("//input[@placeholder='Select
																						// Contact type']");
//		waitEle(By.xpath(xpath));
		String contacttype = String.format("//div[@x-placement]//ul//li[contains(text(), '%s')]", contactType);
		waitEle(By.xpath(contacttype));
	...
	public void SaveuserWF() throws Exception {
		Thread.sleep(10000);
...
//		waitEle(By.xpath("//span[normalize-space()='Continue as Blank Template']"));
	...
	public void Documentsettings1() throws Exception {
	...
	public void Documentsettings() throws Exception {
		...
		Thread.sleep(5000);
		waitEle(By.xpath("//span[text()=' Add eSigns generated id']"));
		Thread.sleep(10000);
...
//		Thread.sleep(10000);
//
//		waitEle(By.xpath("//i[@class=\"el-icon-more el-icon--right\"]"));
...
//	waitEle(By.xpath("//span[text()=' Add eSigns generated id']"));
		...
		// waitEle(By.xpath("(//span[normalize-space()='Save'])[4]"));

	}

	public void NextDocWorkflow() throws Exception {
		Thread.sleep(3000);
		waitEle(By.xpath("//span[normalize-space()='Continue To Next Document']"));

	}

	public void DocGlobalAppSettings() throws Exception {
		// WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
	...
	public void SecureEsignGlobal() throws Exception {
		Actions action = new Actions(driver);
		action.sendKeys(Keys.PAGE_DOWN).perform();
		Thread.sleep(5000); // It's better to replace this with an explicit wait instead of Thread.sleep.
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		Thread.sleep(5000);
		WebElement element = driver.findElement(
				By.xpath("//span[normalize-space()='Allow e-signature OTP validation for all new documents']")); // Replace
																													// with
																													// the
																													// exact
																													// XPath
	...
	public void DocGenerationSettings() throws Exception {
		Actions action = new Actions(driver);
		action.sendKeys(Keys.PAGE_DOWN).perform();
		Thread.sleep(5000); // It's better to replace this with an explicit wait instead of Thread.sleep.
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		Thread.sleep(5000);
		WebElement element = driver.findElement(By.xpath("//span[normalize-space()='Add eSigns generated id']")); // Replace
																													// with
																													// the
																													// exact
																													// XPath
	...
	public void DocGenerationSettings1() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		Thread.sleep(5000);
		WebElement element = driver.findElement(By.xpath("//span[normalize-space()='Add page numbers']")); // Replace
																											// with the
																											// exact
																											// XPath
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
	...
	public void DocGlobalSettingsSave() throws Exception {
		Thread.sleep(5000);
		waitEle(By.xpath("//div[@class=\"sidemenu el-row\"]"));
		Thread.sleep(5000);
		waitEle(By.xpath("//span[normalize-space()='Save Changes']"));
	}

	public void DocGlobalSettingsOnlyAddId() throws Exception {
//		WebElement addESignsGeneratedId=driver.findElement(By.xpath("//label[@class=\"el-checkbox is-checked\"]//span[text()=\" Add eSigns generated id\"]"));
		
		//label[@class="el-checkbox is-checked"]//span[text()=" Add page numbers"]
		//label[@class="el-checkbox is-checked"]//span[text()=" Add page information "]
		//label[@class="el-checkbox is-checked"]//span[text()=" Allow e-signature OTP validation for all new documents"]
//		if()
	}
	public void ensureOnlySecureEsignCheckboxEnabled() throws Exception {
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	    
	    // Define all checkboxes
	    WebElement secureEsignCheckbox = driver.findElement(By.xpath("//span[normalize-space()='Secure Esign']"));
	    WebElement addESignsGeneratedIdCheckbox = driver.findElement(By.xpath("//span[normalize-space()='Add eSigns generated id']"));
	    WebElement addPageNumbersCheckbox = driver.findElement(By.xpath("//span[normalize-space()='Add page numbers']"));
	    WebElement addPageInfoCheckbox = driver.findElement(By.xpath("//span[normalize-space()='Add page info']"));

	    // Ensure 'Secure Esign' checkbox is checked
	    if (!secureEsignCheckbox.isSelected()) {
	        secureEsignCheckbox.click();
	        System.out.println("Checked 'Secure Esign'.");
	    }

	    // Ensure other checkboxes are unchecked
	    if (addESignsGeneratedIdCheckbox.isSelected()) {
	        addESignsGeneratedIdCheckbox.click();
	        System.out.println("Unchecked 'Add eSigns generated id'.");
	    }
	    
	    if (addPageNumbersCheckbox.isSelected()) {
	        addPageNumbersCheckbox.click();
	        System.out.println("Unchecked 'Add page numbers'.");
	    }
	    
	    if (addPageInfoCheckbox.isSelected()) {
	        addPageInfoCheckbox.click();
	        System.out.println("Unchecked 'Add page info'.");
	    }
	}


	public void DocGlobalSettingsOnlyAddpagenumbers() throws Exception {

		Actions action = new Actions(driver);
		action.sendKeys(Keys.PAGE_DOWN).perform();
		Thread.sleep(3000); // It is better to replace this with an explicit wait instead of Thread.sleep.
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement addESignsGeneratedIdCheckbox = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//span[normalize-space()='Add eSigns generated id']"))); // Update with
																											// correct
																											// XPath if
																											// needed
		boolean isChecked = addESignsGeneratedIdCheckbox.isSelected();
		if (isChecked) {

			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",
					addESignsGeneratedIdCheckbox);
			addESignsGeneratedIdCheckbox.click();
			System.out.println("Unchecked 'Add eSigns generated id'.");
			Thread.sleep(10000);
			WebElement addPageNumbersCheckbox = wait.until(
					ExpectedConditions.elementToBeClickable(By.xpath("//span[normalize-space()='Add page numbers']"))); // Update
																														// with
																														// correct
																														// XPath
																														// if
																														// needed
			boolean isChecked1 = addPageNumbersCheckbox.isSelected();
			// Check if "Add page numbers" is not selected
			if (isChecked1) {
				// If not selected, click to select it
				System.out.println("Checked 'Add page numbers'.");
			} else {
				((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",
						addPageNumbersCheckbox);
				addPageNumbersCheckbox.click();
				System.out.println("'Add page numbers' is  checked.");
			}
		} else {
			System.out.println("'Add eSigns generated id' is already unchecked.");
		}
//	    Thread.sleep(10000);
//	    WebElement addPageNumbersCheckbox = wait.until(ExpectedConditions
//	            .elementToBeClickable(By.xpath("//span[normalize-space()='Add page numbers']")));  // Update with correct XPath if needed
//	    boolean isChecked1 = addPageNumbersCheckbox.isSelected();
//	    // Check if "Add page numbers" is not selected
//	    if (isChecked1) {
//	        // If not selected, click to select it
//	        System.out.println("Checked 'Add page numbers'.");
//	    } else {
//	    	 ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", addPageNumbersCheckbox);
//		        addPageNumbersCheckbox.click();
//	        System.out.println("'Add page numbers' is  checked.");
	}
	...
	public void TemplateDocumentsettings() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
		...
		waitEle(By.xpath("//ul[@x-placement]//li[contains(text(), 'Settings')]"));
	...
	public void TemplateClick() throws Exception {
		Thread.sleep(10000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
		By overlayLocator = By.xpath("//div[@class='el-loading-mask is-fullscreen']");
	...
	public void BlankDocTemplate(String s) throws Exception {
		Thread.sleep(10000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(1));
...
//		Thread.sleep(10000);
//		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[text()=\"%s\"]", template1)));
//		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
//		element.click();
//		String file = String.format("//div[text()=\"%s\"]", template1);
//		WebElement element = driver.findElement(By.xpath(file));
//		element.click();
//		//div[text()='TEMPLATE test 23']
...
//		element2.click();
	...
	public void saveAndSend() throws Exception {
		...
		Thread.sleep(1000);
		WebElement element = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()=\" Save & send \"]")));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true); arguments[0].click();",
				element);
...
//		waitEle(By.xpath("//span[text()=\" Save \"]"));
	...
	public void nextButtonAfterAddingTemplates() throws Exception {
		Thread.sleep(10000);
		waitEle(By.xpath("//span[normalize-space()=\"Next\"]"));
	}
