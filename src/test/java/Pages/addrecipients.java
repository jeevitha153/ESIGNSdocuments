...
public class addrecipients {
	...
	public void Recipients() throws Exception {
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath("//div[5]//div[1]//li[32]")).click();

		driver.findElement(By.xpath("//*[@id=\"user_1\"]/form/div/div[2]//div//input")).click();
		Thread.sleep(10000);
		driver.findElement(By.xpath("//div[6]//div[1]//li[5]")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"user_2\"]/form/div/div[1]//input")).click();
		Thread.sleep(10000);
        driver.findElement(By.xpath("//div[5]//div[1]//li[31]")).click();
        driver.findElement(By.xpath("//*[@id=\"user_2\"]/form/div/div[2]//div[1]/input")).click();
		Thread.sleep(10000);
        driver.findElement(By.xpath("//div[7]//div[1]//li[4]")).click();
        driver.findElement(By.xpath("//div[9]//div[1]//li[2]")).click();
