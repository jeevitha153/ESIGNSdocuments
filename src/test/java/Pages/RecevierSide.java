...
//		switchEmail();
	...
	public void clickEmailAuthentication(String s) throws Exception {
		Thread.sleep(10000);
...
////td[@class="x_featured-story__copy"]
	public void OtpAuthentication1() throws Exception {
		Thread.sleep(10000);
	...
	//input[@phalceholder="Enter Verificaiton code"]
	public void OtpAuthenticationEnter() throws Exception {
		Actions actions = new Actions(driver);
...
//		}
		...
		for (String childwindow : allwindowhandles1) {
			...
			public void reviewandSignWF(String s) throws Exception {
				Thread.sleep(10000);
				WebElement copy = driver.findElement(By.xpath("//td[@class=\"x_featured-story__content-inner\"]//span"));
	...
	public void FieldsfillWF() throws Exception {
		waitEle(By.xpath("//span[text()=\"FINISH\"]"));
	...
	public void NextFieldClickWF()throws Exception{
		Thread.sleep(3000);
		waitEle(By.xpath("//span[normalize-space()='NEXT FIELD']"));
	}
	...
	public void fieldsfillWF(String s) throws Exception {
		Thread.sleep(10000);
//	Javascriptclick(By.xpath("//span[normalize-space()='Edit']"));
//	sendKeysToElement(By.xpath("//input[@placeholder='Enter signature']"), "Meghana");
//
...
//		waitEle(By.xpath("//span[normalize-space()='Verify & Save Secure Signature']"));
//		Thread.sleep(5000);
		String xpath = String.format("(//input[@placeholder=\"Enter value\"])[2]", s);
		waitEle(By.xpath(xpath));
...
//		System.out.println("filled TimeRange feild");
	...
	public void receiverSideUpdatedBasicFeildsFill() throws Exception {
		...
		// Weekday
		WebElement element = driver.findElement(By.xpath("//input[@placeholder='Weekdays']"));
...
//		System.out.println("fixedTime field updated");
	...
	public void verifyNeverUpdate(String[] fieldValues, int n) throws Exception {
