...
public class Contacts {
	...
	public void contactsclick() throws Exception {
		Thread.sleep(10000);
		By con = By.xpath("//span[normalize-space()=\"Contacts\"]");
		WebDriverWait cotime = new WebDriverWait(driver, Duration.ofMinutes(3));
		WebElement cocl = cotime.until(ExpectedConditions.elementToBeClickable(con));
		cocl.click();
	}
